...
fun String.white() = "\u001b[37m${this}\u001b[0m"  // White is essentially Graphics.grey, so...
fun String.grey() = "\u001b[37m${this}\u001b[0m"   // ... I've also called it Graphics.grey here!
...
fun String.col(h: Double, s: Double, v: Double): String {
    // Graphics.hsvToRgb coerces values to 0.0 to 1.0, so no need here
...
fun String.col(hex: String): String {
    // Graphics.hexToRgb checks for invalid hex strings, so no need here
